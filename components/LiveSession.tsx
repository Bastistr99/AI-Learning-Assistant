          ...
          <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                  ...
                  <button 
                    ...
                    className={`w-14 h-8 rounded-full p-1 transition-all duration-300 cursor-pointer focus:ring-2 focus:ring-offset-2 focus:ring-accent ${isAiEnabled ? 'bg-accent' : 'bg-gray-200'}`}
